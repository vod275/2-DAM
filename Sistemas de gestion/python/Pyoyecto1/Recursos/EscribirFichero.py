archivo = open('Ejemplo.txt', 'w')  # Si omitimos el modo de apertura lo abre en modo sólo lectura
...
archivo = open('Ejemplo.txt', 'a')  # abre el archivo y pone el cursor al final para añadir
